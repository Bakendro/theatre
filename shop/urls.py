...
from .views import products_page_view, product_details_page_view, delete_product_page_view, edit_product_page_view, \
    index_page_view, category_page_view, basket_page_view, add_product_to_basket_view, delete_from_basket_view

urlpatterns = [
    # products/
    path('', index_page_view, name='index_page'),
    path('basket/', basket_page_view, name='basket'),
    path('add_to_basket/<int:pk>', add_product_to_basket_view, name='add_to_basket'),
